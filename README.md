...
[![Marketplace](https://img.shields.io/visual-studio-marketplace/v/FluxBook.fluxbook?label=Marketplace&logo=visualstudiocode)](https://marketplace.visualstudio.com/items?itemName=FluxBook.fluxbook)

![FluxBook Hero](https://raw.githubusercontent.com/0xdaksh-12/FluxBook/main/assets/screenshots/Hero.png)
...
[![Install in VS Code](https://img.shields.io/badge/Install-VS%20Code%20Marketplace-007ACC?logo=visualstudiocode)](https://marketplace.visualstudio.com/items?itemName=FluxBook.fluxbook)

Search **FluxBook** in the VS Code Extensions panel, or click the badge above.

### From VSIX

1. Download `fluxbook-1.0.0.vsix` from [Releases](https://github.com/0xdaksh-12/FluxBook/releases)
